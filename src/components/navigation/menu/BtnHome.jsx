...
export default function BtnHome({ handleCancel }) {
    ...
    return (
        <div onTouchEnd={handleChangePage} onClick={handleChangePage} className="btn__home btn__navigation">
            <svg style={{ opacity: currentPage.category === 'home' ? 0.5 : 1, transform: `scale(${window.innerWidth / 1920})`, marginTop: `${window.innerHeight / 1080}vh` }} xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42">
