...
export default function BtnBack({ handleCancel }) {
    ...
    return (
        <div onTouchEnd={handlePreviousPage} onClick={handlePreviousPage} className="btn__back btn__navigation">
            <svg style={{ opacity: currentPage.category === 'home' ? 0.5 : 1, transform: `scale(${window.innerWidth / 1920})`, marginTop: `${window.innerHeight / 1080}vh` }} xmlns="http://www.w3.org/2000/svg" width="44.004" height="43.998" viewBox="0 0 44.004 43.998">
